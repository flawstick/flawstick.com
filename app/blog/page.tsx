      ...
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <p className="mt-4 text-zinc-400">
            I write. A lot. In fact, I claim to be the man to out-write
            Nietzsche.
          </p>
        </div>
          ...
          <BlogCard image="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885_1280.jpg">
            <Link href={`/blogs/${featured.slug}`}>
              <article className="relative w-full h-full p-4 md:p-8">
                ...
                <p className="mt-4 leading-6 transition-all ease-in-out duration-150 text-zinc-400 group-hover:text-zinc-300">
